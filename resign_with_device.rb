...
# These are used to decrypt the provided username and password
# You should change them if you integrate this script as is
CYPHER_HASH = "116cc960aa2d4c6e97c4690988460978"
CYPHER_SALT = "8e7ce71ab89945f4a20c3cace0c0d6be"
...
if Spaceship::Portal.client.in_house?
  ...
  profiles = Spaceship.provisioning_profile.ad_hoc.find_by_bundle_id(bundle_id)
